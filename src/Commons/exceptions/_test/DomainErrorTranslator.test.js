...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(DomainErrorTranslator.translate(new Error('THREAD_DETAIL.NOT_CONTAIN_NEEDED_PROPERTY')))
      .toStrictEqual(new InvariantError('tidak dapat melihat detail thread karena properti yang dibutuhkan tidak ada'));
    expect(DomainErrorTranslator.translate(new Error('THREAD_DETAIL.NOT_MEET_DATA_TYPE_SPECIFICATION')))
      .toStrictEqual(new InvariantError('tidak dapat melihat detail thread karena tipe data tidak sesuai'));
    expect(DomainErrorTranslator.translate(new Error('THREAD_DETAIL.COMMENTS_NOT_ARRAY')))
      .toStrictEqual(new InvariantError('tidak dapat melihat detail thread karena comments tidak berbentuk array'));
