...
DomainErrorTranslator._directories = {
  ...
  'THREAD_DETAIL.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat melihat detail thread karena properti yang dibutuhkan tidak ada'),
  'THREAD_DETAIL.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat melihat detail thread karena tipe data tidak sesuai'),
  'THREAD_DETAIL.COMMENTS_NOT_ARRAY': new InvariantError('tidak dapat melihat detail thread karena comments tidak berbentuk array'),
